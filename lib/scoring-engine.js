...
class ScoringEngine {
  ...
  passesQualityThreshold(movie, genreCode) {
    // Use VERY LOW thresholds to filter only truly obscure movies
    // This keeps recognizable titles while allowing enough variety
    const minThresholds = {
      minVotes: 50,      // At least some people voted
      minRating: 4.0,    // Not completely terrible
      minPopularity: 1   // Has some visibility
    };
