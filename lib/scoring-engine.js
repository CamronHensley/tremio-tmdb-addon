...
class ScoringEngine {
  ...
  passesQualityThreshold(movie, genreCode) {
    // Filter for recognizable movies with much higher popularity
    // Higher bar ensures we only get well-known movies
    const minThresholds = {
      minVotes: 300,       // Good vote count
      minRating: 5.5,      // Decent rating
      minPopularity: 50    // Must be quite popular (recognizable)
    };
