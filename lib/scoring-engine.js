...
class ScoringEngine {
   ...
   * TEMPORARILY DISABLED: All movies pass to build up catalog
   */
  passesQualityThreshold(movie, genreCode) {
    // TEMPORARY: Accept all movies to populate catalog
    // Will re-enable with lower thresholds once we verify catalog quality
    return true;
