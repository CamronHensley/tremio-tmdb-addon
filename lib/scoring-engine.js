...
class ScoringEngine {
  ...
  passesQualityThreshold(movie, genreCode) {
    // Filter for recognizable movies with higher popularity
    const minThresholds = {
      minVotes: 200,       // Reasonable vote count
      minRating: 5.0,      // Decent rating
      minPopularity: 20    // Must have good visibility
    };
