...
// Major studio production company IDs (ensures theatrical releases with real budgets)
const MAJOR_STUDIOS = [
  174,    // Warner Bros
...
const THEATRICAL_CERTIFICATIONS = 'G|PG|PG-13|R|NC-17';  // US theatrical ratings
