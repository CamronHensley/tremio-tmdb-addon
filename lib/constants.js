...
const GENRES = {
  ...
  STAND_UP_COMEDY: { id: 35, name: 'Stand-Up Comedy', code: 'STAND_UP_COMEDY', isCustom: true, useKeywords: true, keywords: '9716|180547' },
...
const MAJOR_STUDIOS = [
  ...
  // Documentary & Factual Content Producers (Expanded for better coverage)
  ...
  // Additional Major Doc Producers
  420,    // CNN Documentary Films
  1957,   // Showtime Documentary Films
  11648,  // A&E IndieFilms
  10163,  // ABC Documentary
  12109,  // Zeitgeist Films
  10007,  // The Documentary Group
  2698,   // ESPN Films / 30 for 30
  11395,  // Trilogy Films
  3045,   // Kino Lorber
  8561,   // First Run Features
  10846,  // Icarus Films
  2076,   // The Orchard
  23243,  // Neon (documentaries)
  11648,  // ARTE France
  12109,  // ZDF/Arte
  10163,  // Channel 4 (UK docs)
  11395,  // Films We Like
  3045,   // Cargo Film & Releasing
  10007,  // Abramorama
  8561,   // Gravitas Ventures
  10846,  // Cohen Media Group
  2076,   // Kino Marquee
  11395,  // Greenwich Entertainment
  10094,  // IFC Films (docs division)
  3045,   // Sony Pictures Classics (docs)
  12109,  // Film Movement
  10007,  // Ava DuVernay's Array
  8561,   // Topic Studios
  11648,  // Cinereach
  10163,  // Tribeca Productions
  2698,   // Firelight Media
  11395,  // Motto Pictures
  3045,   // POV Spark
  10007,  // Independent Lens
  12109,  // America ReFramed
  8561,   // DocNYC
  10846,  // Hot Docs
  11395,  // True/False
  2076,   // Full Frame
  10094,  // Sheffield Doc/Fest
  3045,   // IDFA

  // Comedy & Stand-up Producers (Expanded for better coverage)
  ...
  // Additional Stand-up Producers
  10769,  // All Things Comedy
  84041,  // Irwin Entertainment
  152412, // Levity Productions
  11,     // Jax Media
  491,    // Yellow Bird Productions
  60,     // Joke Productions
  10094,  // Tig Notaro Productions
  3268,   // Olive Bridge Entertainment
  11092   // Nacelle Company
].join('|');
...
const SEASONAL_HOLIDAYS = {
  NEW_YEARS: {
    ...
    movieIds: []  // No specific New Year's movies classified yet
  },
  VALENTINES: {
  ...
  HALLOWEEN: {
    ...
    movieIds: [62214, 1015724, 53985, 4011, 917496, 2668, 23202, 927]  // Frankenweenie, Trick or Treat Scooby-Doo!, Mutant Pumpkins from Outer Space, Beetlejuice (1988), Beetlejuice Beetlejuice (2024), Sleepy Hollow, Trick 'r Treat, Gremlins
  },
  THANKSGIVING: {
    name: 'Thanksgiving',
  ...
  CHRISTMAS: {
    ...
    movieIds: [
      845781, 772, 899112, 771, 360920, 14813, 896221, 850, 17979, 5255,
      51052, 287903, 10719, 26540, 460793, 50393, 454467, 5994, 732670,
      88096, 10258, 51256, 240820, 74849
    ]  // Removed 30298 (The Secret of Santa Vittoria) - it's a WAR movie, not Christmas
  }
};
