...
const QUALITY_THRESHOLDS = {
  DEFAULT: { minVotes: 50, minRating: 7.0, minPopularity: 5 },  // High rating, minimal votes
  DOCUMENTARY: { minVotes: 30, minRating: 7.5, minPopularity: 3 },
  TVMOVIE: { minVotes: 40, minRating: 7.0, minPopularity: 4 },
  HORROR: { minVotes: 50, minRating: 6.5, minPopularity: 5 }  // Horror typically rated lower
};
