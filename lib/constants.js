...
const SEASONAL_HOLIDAYS = {
  CHRISTMAS: {
    name: 'Christmas',
    dateRanges: [{ start: '11-15', end: '12-31' }],
    tmdbKeywordIds: [207317, 6962, 9377]
  },
  HALLOWEEN: {
    name: 'Halloween',
    dateRanges: [{ start: '10-01', end: '11-05' }],
    tmdbKeywordIds: [9882],
    excludeGenres: [27]
  },
  THANKSGIVING: {
    name: 'Thanksgiving',
    dateRanges: [{ start: '11-01', end: '11-30' }],
    tmdbKeywordIds: [186565]
  },
  VALENTINES: {
    name: "Valentine's Day",
    dateRanges: [{ start: '01-25', end: '02-20' }],
    tmdbKeywordIds: [10683]
  },
  SUMMER: {
    name: 'Summer',
    dateRanges: [{ start: '05-20', end: '09-05' }],
    tmdbKeywordIds: [10683, 6270]
  }
};
...
function getCurrentSeason() {
  ...
  const holidays = ['CHRISTMAS', 'HALLOWEEN', 'THANKSGIVING', 'VALENTINES', 'SUMMER'];
