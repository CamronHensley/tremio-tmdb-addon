...
// Raised to filter out obscure movies while maintaining ~100 per genre
const QUALITY_THRESHOLDS = {
  DEFAULT: { minVotes: 500, minRating: 6.0, minPopularity: 5 },
  DOCUMENTARY: { minVotes: 200, minRating: 6.0, minPopularity: 2 },
  TVMOVIE: { minVotes: 200, minRating: 5.5, minPopularity: 3 },
  HORROR: { minVotes: 300, minRating: 5.5, minPopularity: 5 },
  ANIMATION: { minVotes: 500, minRating: 6.5, minPopularity: 5 },
  FAMILY: { minVotes: 400, minRating: 6.0, minPopularity: 5 }
};
