...
const QUALITY_THRESHOLDS = {
  DEFAULT: { minVotes: 0, minRating: 6.5, minPopularity: 10 },  // Use popularity + rating (era-agnostic)
  DOCUMENTARY: { minVotes: 0, minRating: 7.0, minPopularity: 5 },
  TVMOVIE: { minVotes: 0, minRating: 6.5, minPopularity: 8 },
  HORROR: { minVotes: 0, minRating: 6.0, minPopularity: 8 }
};
