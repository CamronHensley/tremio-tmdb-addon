...
const QUALITY_THRESHOLDS = {
  DEFAULT: { minVotes: 500, minRating: 6.0, minPopularity: 5 },
  DOCUMENTARY: { minVotes: 1000, minRating: 6.5, minPopularity: 3 },
  TVMOVIE: { minVotes: 300, minRating: 6.5, minPopularity: 5 },
  HORROR: { minVotes: 300, minRating: 5.5, minPopularity: 3 }
};
...
// Increased pages to ensure enough movies for all genres
const PAGE_ROTATION = {
  0: [1, 2, 3, 4, 5],  // Week 1 - 5 pages for better coverage
  1: [2, 3, 4, 5, 6],  // Week 2
  2: [3, 4, 5, 6, 7],  // Week 3
  3: [1, 4, 7, 8, 9]   // Week 4 (mixed sampling)
};
...
const MOVIES_PER_GENRE = parseInt(process.env.MOVIES_PER_GENRE || '30', 10);
