...
// Balanced to show recognizable movies without filtering too aggressively
const QUALITY_THRESHOLDS = {
  DEFAULT: { minVotes: 300, minRating: 5.8, minPopularity: 3 },
  ANIMATION_KIDS: { minVotes: 300, minRating: 6.0, minPopularity: 4 },
  ANIMATION_ADULT: { minVotes: 250, minRating: 6.5, minPopularity: 3 },
  DOCUMENTARY: { minVotes: 150, minRating: 5.8, minPopularity: 1 },
  TVMOVIE: { minVotes: 150, minRating: 5.5, minPopularity: 2 },
  HORROR: { minVotes: 200, minRating: 5.5, minPopularity: 3 },
  FAMILY: { minVotes: 300, minRating: 5.8, minPopularity: 4 }
};
...
const GENRE_PERSONALITIES = {
  ...
  ACTION_CLASSIC: {
    goldenEraBonus: { yearRange: [1980, 1999], bonus: 0.2 },  // 80s-90s action peak
    classicActionBonus: 0.15,   // Reward iconic classics
    audienceValidationWeight: 1.2  // Vote count matters for classics
  },
  ANIMATION_KIDS: {
    franchiseBonus: 0.15,           // Pixar/Disney franchises
    audienceValidationWeight: 1.2,  // Vote count matters
    holidayBoost: { months: [11, 12], bonus: 0.15 }  // Holiday season
  },
  ANIMATION_ADULT: {
    criticalAcclaimWeight: 1.3,     // Rating matters more for adult animation
    cultFilmBonus: 0.1              // Lower popularity acceptance
  },
  HORROR: {
  ...
  SUPERHEROES: {
    franchiseBonus: 0.2,            // Marvel/DC franchises
    highBudgetBonus: 0.15,          // Big budget blockbusters
    audienceValidationWeight: 1.3,  // Vote count matters
    recentYearBonus: 0.1            // Modern superhero era
  },
  ROMANCE: {
