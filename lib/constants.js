...
const QUALITY_THRESHOLDS = {
  ...
  ANIMATION_KIDS: { minVotes: 400, minRating: 6.2, minPopularity: 4 },
  ANIMATION_ADULT: { minVotes: 400, minRating: 6.5, minPopularity: 4 },
...
const GENRE_PERSONALITIES = {
  ...
  ANIMATION_ADULT: {
    studioReputationWeight: 1.2,
    criticalAcclaimWeight: 1.15
  },
  DOCUMENTARY: {
    recencyWeight: 1.2,
    topicalBonus: 0.1
