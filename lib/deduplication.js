...
class DeduplicationProcessor {
      ...
      for (const movie of movies) {
        ...
        if (isSuperhero) {
          ...
          const isKidsAnimation = hasFamily ||
                                   ...
                                   (movie.title && /\b(Toy Story|Finding Nemo|Frozen|Moana|Shrek|Lion King|Cars|Up|WALL-E|Ratatouille|Inside Out|Coco|Zootopia|Minions|Despicable Me|Kung Fu Panda|How to Train Your Dragon|Tangled|Brave|Big Hero 6|Wreck-It Ralph|The Incredibles)\b/i.test(movie.title));
  ...
  fillGenreAggressive(result, genreCode, moviesByGenre) {
    ...
    // BUT still respects pre-1970s limit and Japanese anime blocking
