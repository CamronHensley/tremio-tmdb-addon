    ...
    for (const genreCode of allGenreCodes) {
      ...
      for (const movie of movies) {
        ...
        // TIER 2: ERA-BASED SPLITS (Action split by year)
          ...
          if (genreCode === 'ACTION_CLASSIC' && !isClassicEra) continue;  // Modern action, skip classic
          if (genreCode === 'ACTION' && isClassicEra) continue;  // Classic action, skip modern
