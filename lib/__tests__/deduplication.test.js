...
describe('DeduplicationProcessor', () => {
  ...
  describe('processAllGenres', () => {
    it('should ensure each movie appears only once', () => {
      const moviesByGenre = {
        ACTION: [
          { id: 1, genre_ids: [28], vote_count: 5000, vote_average: 8.0, popularity: 100, release_date: '2023-01-01' },
          { id: 2, genre_ids: [28], vote_count: 3000, vote_average: 7.5, popularity: 80, release_date: '2023-02-01' },
          { id: 3, genre_ids: [28], vote_count: 4000, vote_average: 7.8, popularity: 90, release_date: '2023-03-01' }
        ],
        DRAMA: [
          { id: 1, genre_ids: [28, 18], vote_count: 5000, vote_average: 8.0, popularity: 100, release_date: '2023-01-01' }, // Duplicate (primary genre is ACTION)
          { id: 4, genre_ids: [18], vote_count: 6000, vote_average: 8.5, popularity: 110, release_date: '2023-04-01' },
          { id: 5, genre_ids: [18], vote_count: 2500, vote_average: 7.2, popularity: 70, release_date: '2023-05-01' }
        ]
      };
    ...
    it('should assign movies to their highest scoring genre', () => {
      const sharedMovie = {
        id: 1,
        genre_ids: [18], // Drama as primary genre
        vote_count: 10000,
        vote_average: 9.0,
        popularity: 200,
    ...
    it('should apply historical penalty to recent movies', () => {
      const moviesByGenre = {
        ACTION: [
          { id: 1, genre_ids: [28], vote_count: 5000, vote_average: 8.0, popularity: 100, release_date: '2023-01-01' },
          { id: 2, genre_ids: [28], vote_count: 5000, vote_average: 8.0, popularity: 100, release_date: '2023-02-01' }
        ]
      };
    ...
    it('should filter out movies below quality threshold', () => {
      const moviesByGenre = {
        ACTION: [
          { id: 1, genre_ids: [28], vote_count: 10, vote_average: 3.0, popularity: 1 }, // Bad movie
          { id: 2, genre_ids: [28], vote_count: 5000, vote_average: 8.0, popularity: 100, release_date: '2023-01-01' }
        ]
      };
