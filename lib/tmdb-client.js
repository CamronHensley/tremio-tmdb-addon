...
class TMDBClient {
  ...
  async discoverMovies(genreId, options = {}) {
    ...
    const params = {
      ...
      sort_by: sortBy,
      page,
      'vote_count.gte': minVotes || 200,  // 200+ votes allows classics while blocking obscure
      'vote_average.gte': minRating || 6.5,  // Higher rating compensates for lower vote count
      include_adult: false,
      include_video: false,
      language: 'en-US',
