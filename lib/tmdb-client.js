...
class TMDBClient {
  ...
  async discoverMovies(genreId, options = {}) {
    const {
      page = 1,
      sortBy = 'vote_average.desc',  // Sort by rating to get quality across all eras
      minVotes = 0,
      minRating = 0,
      releaseDateGte,
      releaseDateLte,
    ...
    const params = {
      ...
      sort_by: sortBy,
      page,
      'vote_count.gte': minVotes || 50,  // Low threshold - just enough to filter complete unknowns
      'vote_average.gte': minRating || 7.0,  // High rating = quality (works for all eras)
      include_adult: false,
      include_video: false,
      language: 'en-US',
